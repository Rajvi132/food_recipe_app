...
class _ChinesePageState extends State<ChinesePage> {
  ...
  // Fetch Chinese dishes from Firestore
  void fetchChineseDishes() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('dishes')
        .where('categories', isEqualTo: 'Chieneseee')
        .get();
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () => navigateToRecipeDetail(dish['id']), // Pass the dynamic ID
                    child: Stack(
                      children: [
                        Card(
