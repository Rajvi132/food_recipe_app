...
class _PunjabiPageState extends State<PunjabiPage> {
  ...
  void fetchPunjabiDishes() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('dishes')
        .where('categories', isEqualTo: 'Punjabi')
        .get();
  ...
  void shareOnWhatsApp(Map<String, dynamic> dish) async {
    ...
    final text = "🍛 *Check out this Punjabi recipe!*\n\n"
        "*Dish:* $name\n"
        "*Time:* $time\n\n"
        "📺 Watch: $videoUrl";
